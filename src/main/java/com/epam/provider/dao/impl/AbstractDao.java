 ...
 * To implement this class subclasses may implement getSql methods or override getPS methods if they need
 *
 * @author Gleb Aksenov
 */
public abstract class AbstractDao<T extends Entity> implements GenericDao<T> {
    ...
    PreparedStatement getPSFindLimited(Connection con, Integer start, Integer end, String lang) throws SQLException {
        PreparedStatement ps = null;
        try {
