...
public class ConnectionPool {
    ...
    private ConnectionPool() {
        try {
            ...
            poolSize = Integer.parseInt(resourceBundle.getString(ResourceConstants.POOL_SIZE_PROPERTY_KEY));
            activePool = new ArrayBlockingQueue<Connection>(poolSize);
    ...
    public void initPoolData() {
        ...
        try {
            for (int i = 0; i < poolSize; i++) {
                activePool.offer(ConnectorDB.getConnection());
            }
    ...
    public class PooledConnection implements Connection {
        ...
        public void close() throws SQLException {
            if (connection.isClosed()) {
                throw new SQLException(MessageResourceManager.getProperty(""));
            }
