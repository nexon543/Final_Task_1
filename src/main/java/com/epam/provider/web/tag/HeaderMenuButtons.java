...
public class HeaderMenuButtons extends TagSupport {
    ...
    public int doAfterBody() throws JspException {
        StringBuilder buttons = new StringBuilder("<ul class=\"nav navbar-nav\">")
                .append("<li class=\"active\"><a href=\"${pageContext.request.contextPath}/index.jsp\">Home</a></li>")
                .append("<li><a href=\"${pageContext.request.contextPath}/Controller?command=get_tariffs\">Tariffs</a></li>")
                .append("</ul>");
        try {
