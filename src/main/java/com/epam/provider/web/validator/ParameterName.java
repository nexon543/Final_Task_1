...
public enum ParameterName {
    ...
    static {
        paramNameSets = new EnumMap<ActionType, EnumSet<ParameterName>>(ActionType.class);
        paramNameSets.put(ActionType.LOGIN, EnumSet.of(LOGIN, PASSWORD));
        paramNameSets.put(ActionType.ADD_BALANCE, EnumSet.of(BALANCE));
        paramNameSets.put(ActionType.ADD_PROFILE, EnumSet.of(FIRST_NAME, SECOND_NAME, PASSPORT, LOGIN, PASSWORD, ROLE, ID_TARIFFS));
        paramNameSets.put(ActionType.ADD_TARIFF, EnumSet.of(DESCRIPTION, RECIEVING_SPEED, TRANSFER_SPEED, TARIFF_NAME, PRICE));
