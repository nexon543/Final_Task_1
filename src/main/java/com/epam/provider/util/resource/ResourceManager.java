...
public class ResourceManager {
    ...
    public static void initResources() {
        ...
        defaultMessageBundle = ResourceBundle.getBundle(ResourceConstants.RESOURCE_PATH_MESSAGE, Locale.getDefault());
    }

    public static String getMessage(String key, String lang) {
        if (!ResourceManager.currentLocale.getLanguage().equals(lang)) {
            ResourceManager.currentLocale = new Locale(lang);
            messageBundle = ResourceBundle.getBundle(ResourceConstants.RESOURCE_PATH_MESSAGE, currentLocale);
        }
    ...
    public static String getPagePath(String pageName) {
        return pageBundle.getString(ResourceConstants.PAGE_PATH_PREFIX + pageName);
    }
