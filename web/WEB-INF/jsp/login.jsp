    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li><a href="${pageContext.request.contextPath}/Controller?command=get_tariff">Tariffs</a></li>
            </ul>
                ...
                <li>
                    <c:choose>
                        <c:when test="${user != null}">
                            <a href="/Login"><span class="glyphicon glyphicon-log-in"> Go to cabinet </span></a>
                        </c:when>
                        <c:otherwise>
