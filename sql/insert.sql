INSERT INTO `mydb`.`Tariffs` (`id_tariffs`, `recieving_speed`, `transfering_speed`, `price`,`isUnlim`) VALUES (1, 3072, 512, 25, 0);
INSERT INTO `mydb`.`Tariffs` (`id_tariffs`, `recieving_speed`, `transfering_speed`, `price`,`isUnlim`) VALUES (2, 4096, 512, 75, 1);
INSERT INTO `mydb`.`Tariffs` (`id_tariffs`, `recieving_speed`, `transfering_speed`, `price`,`isUnlim`) VALUES (3, 6144, 512, 16.5, 1);
INSERT INTO `mydb`.`Tariffs` (`id_tariffs`, `recieving_speed`, `transfering_speed`, `price`,`isUnlim`) VALUES (4, 8192, 512, 16.5, 1);
INSERT INTO `mydb`.`Tariffs` (`id_tariffs`, `recieving_speed`, `transfering_speed`, `price`,`isUnlim`) VALUES (5, 3072, 512, 16.5, 1);
...
INSERT INTO `mydb`.`Profiles` (`first_name`, `second_name`, `passport`, `id_tariffs`, `balance`, `register_date`) VALUES ('Ivan', 'Ivanov', 'MP267523', 1, 170, '2017-12-02');
INSERT INTO `mydb`.`Profiles` (`first_name`, `second_name`, `passport`, `id_tariffs`, `balance`, `register_date`) VALUES ('Admin', 'Admin', 'Admin', 1, 0, '2007-12-02');

INSERT INTO `mydb`.`Users` (`login`, `pass`, `id_profiles`, `role`) VALUES ('user', 'user', 1, 'client');
INSERT INTO `mydb`.`Users` (`login`, `pass`, `id_profiles`, `role`) VALUES ('admin', 'admin', 1, 'admin');
